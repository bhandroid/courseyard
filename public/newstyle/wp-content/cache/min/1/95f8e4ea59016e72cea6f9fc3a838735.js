            ...
            var lazyVideoObserver = new IntersectionObserver(function(entries, observer) {
                entries.forEach(function(video) {
                    if (video.isIntersecting) {
                        set_query_source(video.target, !0)
                    }
                })
            }, {
                rootMargin: "300px",
...
var wpulivesearch_settings = {
    "fulltext_and_filters": "1",
    "fulltext_keys": ["name"],
    "sort_results_callback": "",
    "nb_items_in_pager": "9",
    "load_all_default": "1",
    "pager_load_more": "1",
    "dynamic_url": "1",
    "results_per_page": "5",
    "inclusive_search": "",
    "view_selected_multiple_values": "",
    "view_selected_simple_replace_label": "",
    "view_selected__before": "(",
    "view_selected__after": ")",
    "minimal_fulltext_value": "1",
    "minimal_numeric_value": "0",
    "search_form_order": ["search_form", "filters", "reset"],
    "plugin_version": "0.14.10"
};
document.addEventListener('wpulivesearch_datas_ready', function() {
    ...
    function live_search() {
        ...
        var _results = [],
            ...
            _hasFilterValue = !1,
            _filtersValues = [],
            _hasFullText, _hasFilters, i, len;
...
function wpulivesearch_extract_active_filters(_results, $filters, $filters_multiples) {
    var active_filters = {},
        _filter, _filter_key, ii, i, tmp_result;
...
function wpulivesearch_reset_active_filters($filters) {
    ...
    for (var i = 0, len = $filters.length; i < len; i++) {
        if ($filters[i].tagName == 'SELECT') {
            ...
            wpulivesearch_set_active_filters__select([], $filters[i], !0)
        } else {
            wpulivesearch_set_active_filters__multiple([], $filters[i], !0)
        }
    }
    return _hasDefault
}
...
function wpulivesearch_set_active_filters(active_filters, $filters) {
    ...
    for (var i = 0, len = $filters.length; i < len; i++) {
        ...
        if ($filters[i].tagName == 'SELECT') {
            wpulivesearch_set_active_filters__select(_active_filter, $filters[i], !1)
        } else {
            wpulivesearch_set_active_filters__multiple(_active_filter, $filters[i], !1)
        }
    }
}
...
function wpulivesearch_set_active_filters__select(active_filters, $el, force) {
    ...
    for (var i = 0; i < op.length; i++) {
        if (wpulivesearch_settings.inclusive_search) {
            op[i].disabled = force ? !1 : active_filters.indexOf(op[i].value) < 0
        }
    }
    if (force) {
        var _index = 0;
...
function wpulivesearch_set_active_filters__multiple(active_filters, $el, force) {
    ...
    var $opts = $el.querySelectorAll('input[type="checkbox"]'),
        ...
        _isHiddenValue, _itemParent, _visibleValues = [],
        _nbEnabled = 0;
...
function wpulivesearch_filters_search(_filtersValues, _item) {
    'use strict';
    var has_filter, filter_values, filter_id, filter_intersect, filter_value_arr, i, len;
    for (i = 0, len = _filtersValues.length; i < len; i++) {
...
function wpulivesearch_get_filter_html(_key, _value) {
    ...
    var is_multiple = (_value.multiple == '1'),
        ...
        _tmpValue, _extra_attr, _selected, _item_id, _val;
    var _initial = [];
...
var morphHTMLNumber = function(a) {
    "use strict";
    var b, c, d, e = "data-ismorphing";
    return !!a && (a.tagName && (a = {
        el: a
    }), !!a.el && void("1" != a.el.getAttribute(e) && (a.el.setAttribute(e, 1), a = this.setOptions(a), d = a.startValue, b = (a.finalValue - a.startValue) / (a.time / a.intervalDelay), a.el.innerHTML = d, c = setInterval(function() {
        d += b, a.isFloat ? a.el.innerHTML = d.toFixed(a.nbDecimals) : a.el.innerHTML = Math.ceil(d)
    }, a.intervalDelay), setTimeout(function() {
        clearInterval(c), a.isFloat ? a.el.innerHTML = a.finalValue.toFixed(a.nbDecimals) : a.el.innerHTML = a.finalValue, a.el.setAttribute(e, 0)
    }, a.time))))
};
morphHTMLNumber.prototype.setOptions = function(a) {
    "use strict";
    var b = 1500,
        c = "data-morphtime";
    a.el.getAttribute(c) && (b = a.el.getAttribute(c)), a.time = a.time || b;
    var d = 25,
        e = "data-morphintervaldelay";
    a.el.getAttribute(e) && (d = a.el.getAttribute(e)), a.intervalDelay = a.intervalDelay || d;
    var f = !1,
        g = "data-morphisfloat";
    a.el.getAttribute(g) && (f = !!a.el.getAttribute(g)), a.isFloat = a.isFloat || f;
    var h = !1,
        i = "data-morphisreverse";
    a.el.getAttribute(i) && (h = !!a.el.getAttribute(i)), a.isReverse = a.isReverse || h;
    var j = 2,
        k = "data-morphnbdecimals";
    a.el.getAttribute(k) && (j = a.el.getAttribute(k)), a.nbDecimals = a.nbDecimals || j;
    var l = "data-finalvalue";
    a.finalValue || (a.el.getAttribute(l) ? a.finalValue = a.el.getAttribute(l) : a.finalValue = a.el.innerHTML), a.isFloat ? a.finalValue = parseFloat(a.finalValue, 10) : a.finalValue = parseInt(a.finalValue, 10);
    var m = "data-startValue";
    return a.startValue || (a.el.getAttribute(m) ? a.startValue = a.el.getAttribute(m) : a.isReverse ? a.startValue = 100 : a.startValue = 0), a.startValue && (a.isFloat ? a.startValue = parseFloat(a.startValue, 10) : a.startValue = parseInt(a.startValue, 10)), a
};
var vanillaAnimateWords = function(t, r) {
    "use strict";
    var e = {
            delay: .05,
            wrapEl: "SPAN",
            innerEl: "SPAN",
            triggerReady: function(t) {
                t.setAttribute("data-vawjs-ready", "1")
            }
        },
        a = function(t, r) {
            var e = "",
                ...
                o = t.replace(l, "").trim();
            if (!o) return n(t, r);
            if (o && !l) return o.trim();
            for (var f = i(t), s = 0, c = f.length; s < c; s++) e += a(f[s], r);
            return e
        },
        n = function(t, r) {
            var a = "<" + e.wrapEl + ' class="vawjs-word-wrapper">';
            return a += "<" + e.innerEl + ' class="vawjs-word" style="animation-delay:' + r * e.delay + 's">', a += t, a += "</" + e.innerEl + ">", a += "</" + e.wrapEl + ">"
        };

    function i(t) {
        return (t = t.trim()).replace(">", "> ").replace("<", " <").replace("</", " </").split(" ").filter(function(t) {
            return t
        })
    }
    return function(r) {
        ...
        t.getAttribute("data-vawjs-delay") && (e.delay = parseInt(t.getAttribute("data-vawjs-delay"), 10) / 1e3), t.style.height = t.offsetHeight,
            function() {
                var r = t.innerHTML,
                    e = [];
                ! function() {
                    var t, a = r.match(/<([^>]*?)>/gi);
                    if (a)
                        for (var n = 0, i = a.length; n < i; n++) t = "<__tmptag" + n + "__>", e.push({
                            tag: t,
                            original: a[n]
                        }), r = r.replace(a[n], t)
                }();
                var n = i(r),
                    l = "";
                t.innerHTML = "";
                for (var o = 0, f = 0, s = n.length; f < s; f++) l += a(n[f], o++);
                ! function() {
                    for (var t = 0, r = e.length; t < r; t++) l = l.replace(e[t].tag, e[t].original)
                }(), t.innerHTML = l
            }(),
            function() {
                if (t.style.height = "", t.getAttribute("data-vawjs-lines")) {
                    var r = 0,
                        a = 0;
                    t.querySelectorAll(".vawjs-word").forEach(function(t) {
                        t.offsetTop > r && (r = t.offsetTop, a++), t.style.animationDelay = (a - 1) * e.delay + "s"
                    })
                }
            }(), e.triggerReady(t)
    }(r), this
...
var wputhmenu = {
    ...
    has_floating_menu: !1,
    has_bfloating_menu: !1,
    has_mfloating_menu: !1,
    scrollLimit: 100,
    scrollLimitB: !1,
    scrollLimitMobile: !1,
    itemBody: !1,
...
var wpu_remove_utm_ga = function() {
    ...
    history.replaceState({}, !1, parser.href)
};
...
function wputheme_setcookie(cookie_name, cookie_value, expiration_days, path) {
    ...
    document.cookie = cookie_name + '=' + cookie_value + ';' + 'expires=' + d.toUTCString() + ';' + 'path=' + path
}
...
jQuery(document).ready(function() {
    $jQbody = jQuery('body');
    wputhmenu.CSSClassNameM = 'prepare-floating-menu';
    wputhmenu.CSSClassNameB = 'will-have-floating-menu';
    wputhmenu.CSSClassName = 'has-floating-menu';
    wputhmenu.scrollLimitMobile = 150;
...
function jsu_get_responsive_layout(e) {
    "use strict";
    e = e || document.body;
    var t = window.getComputedStyle(e, ":after").getPropertyValue("content");
    return t = (t = t.replace(/"/g, "")) || "none"
};
jQuery(document).ready(function() {
    var e = jQuery("body"),
        t = 1e3;
    wputheme_getcookie("algoan_home_anim") && (t = 100, e.addClass("no-home-animation")), setTimeout(function() {
        e.attr("data-page-loaded", 1)
    }, 1 * t), setTimeout(function() {
        jQuery("[data-loader-delay]").each(function() {
            var e = jQuery(this);
            ! function(e, t) {
                setTimeout(function() {
                    t.addClass("is-loaded"), t.attr("data-delay") && (window.dispatchEvent(new Event("resize")), t.get(0).dispatchEvent(new Event("activescrollanim")))
                }, e)
            }(parseInt(e.attr("data-loader-delay"), 10), e)
        })
    }, 2.5 * t), setTimeout(function() {
        e.attr("data-loader-over", 1), wputheme_setcookie("algoan_home_anim", "1", .1)
    }, 3.5 * t), setTimeout(function() {
        e.attr("data-loader-after", 1)
    }, 4.5 * t)
});
jQuery(document).ready(function() {
    var e, n = jQuery("body");
    jQuery("body").on("click", ".open-menu, .header-main .close, .close-menu, .header-main__overlay", function(e) {
        e.preventDefault(), $jQbody.toggleClass("has--opened-main-menu")
    }), (e = jQuery(".main-menu .menu-item-has-children")).hoverIntent({
        timeout: 200,
        over: function() {
            jQuery(this).attr("data-hover-intent", "1"), n.attr("data-menu-item-hover", "1")
        },
        out: function() {
            jQuery(this).attr("data-hover-intent", "0"), setTimeout(function() {
                e.filter('[data-hover-intent="1"]').length || n.attr("data-menu-item-hover", "0")
            }, 250)
        }
        ...
        var e = jQuery(this),
            ...
            i = jQuery('<div class="big-submenu"><div class="big-submenu__header"><a href="#" class="close-submenu"><i class="icon icon_back"></i>' + n.text() + '</a><a href="#" class="close-menu"><i class="icon icon_close"></i></a></div></div>');
        e.append(i), e.append(jQuery('<a href="#" class="open-submenu"><i class="icon icon_go"></i></a>')), i.append(a)
    }), jQuery(".main-menu").on("click", '.menu-item-has-children > a[href="#"], .open-submenu, .close-submenu', function(e) {
        e.preventDefault(), jQuery(this).closest(".menu-item-has-children").toggleClass("is-opened")
    })
});
document.documentElement.style.setProperty("--scrollbar-width", "16px"), document.documentElement.style.setProperty("--scrollbar-width-half", "8px"), jQuery(document).ready(function() {
    var e = function() {
        var e = window.innerWidth - document.documentElement.clientWidth;
        document.documentElement.style.setProperty("--scrollbar-width", e + "px"), document.documentElement.style.setProperty("--scrollbar-width-half", Math.round(e / 2) + "px")
    };
    jQuery(window).resize(e), e()
});
jQuery(document).ready(function(e) {
    jQuery("body").on("keyup blur", "textarea", function() {
        var t = e(this);
        t.outerHeight() > t.prop("scrollHeight") && t.outerHeight(5);
        t.outerHeight(t.prop("scrollHeight"))
    })
});
jQuery(document).ready(function(u) {
    jQuery(".block--columns").each(function() {
        jQuery(this)
    })
});
jQuery(document).ready(function(c) {
    jQuery(".block--cta").each(function() {
        jQuery(this)
    })
});

function algoanFormsReady(t) {
    t.on("change blur", "input,textarea", function(t) {
        var e = jQuery(this);
        e.closest(".input").attr("data-focus", "0").attr("data-hasvalue", e.val() ? "1" : "0")
    }), t.on("focus", "input,textarea", function(t) {
        jQuery(this).closest(".input").attr("data-focus", "1")
    }), t.find("input, textarea").each(function() {
        jQuery(this).trigger("blur"), this.getAttribute("placeholder") && jQuery(this).closest(".input").attr("data-placeholder", "1")
    }), t.find("label + legend + div.input > input,label + legend + div.input > textarea, .algoan-basic-input label").each(function() {
        var t = jQuery(this),
            e = t.closest(".hs-form-field"),
            a = e.children("label");
        "file" != t.attr("type") && "hidden" != t.attr("type") && e.append(a)
    }), t.find(".hs-form-field .hs-field-desc").each(function() {
        var t = jQuery(this),
            e = t.closest(".hs-form-field");
        e.hasClass("hs-fieldtype-booleancheckbox") || e.append(t)
    })
}
jQuery(document).ready(function(t) {
    jQuery("#loginform, #lostpasswordform").each(function() {
        var t = jQuery(this);
        t.find(".login-password,.login-username").addClass("input algoan-basic-input hs-form-field"), algoanFormsReady(t)
    })
});
jQuery(document).ready(function(e) {
    jQuery(".block--list").each(function() {
        jQuery(this)
    })
});
jQuery(document).ready(function(t) {
    jQuery(".cc-block-logos").each(function() {
        var t = jQuery(this),
            e = t.find(".logos-list"),
            o = jQuery('<button class="logos-cursor" type="button"></button>');
        t.append(o), t.on("mousemove", function(e) {
            var o = t.get(0),
                s = o.getBoundingClientRect(),
                i = e.clientX - s.x,
                n = e.clientY - s.y;
            _position = s.width - i < s.width / 2 ? "right" : "left", o.setAttribute("data-cursor-position", _position), i = Math.min(s.width - 40, i), i = Math.max(40, i), o.style.setProperty("--mouse-x", i + "px"), o.style.setProperty("--mouse-y", n + "px")
        }), t.on("click", function(o) {
            jQuery(o.target).closest("a").length || (o.preventDefault(), e.slick("left" == t.attr("data-cursor-position") ? "slickPrev" : "slickNext"))
        }), t.on("mouseenter", "a", function(e) {
            t.attr("data-inslider", 1)
        }).on("mouseleave", "a", function(e) {
            t.attr("data-inslider", 0)
        }), e.slick({
            infinite: !0,
            slidesToShow: 4,
            autoplay: !0,
...
jQuery(document).ready(function(t) {
    jQuery(".cc-block--master-header").each(function() {
        var t, e = jQuery(this),
            n = e.find(".field-cta a");
        "404" != e.attr("data-post-type") && (e.on("mousemove", function(n) {
            var a = e.get(0),
                o = a.getBoundingClientRect(),
                i = n.clientX - o.x,
                u = n.clientY - o.y;
            t = o.height, i = Math.min(o.width - 43, i), i = Math.max(43, i), u = Math.min(o.height - 43, u), u = Math.max(43, u), a.style.setProperty("--mouse-x", i + "px"), a.style.setProperty("--mouse-y", u + "px")
        }), e.on("click", function(n) {
            "1" != e.attr("data-inbutton") && (n.preventDefault(), jQuery("html,body").animate({
                scrollTop: t
            }, 500))
        }), n.on("mouseenter", function(t) {
            e.attr("data-inbutton", 1)
        }).on("mouseleave", function(t) {
            e.attr("data-inbutton", 0)
        }))
    })
});
jQuery(document).ready(function(e) {
    jQuery(".block--numbers [data-nb]").each(function() {
        this.innerHTML = "0"
    }), jQuery(".block--numbers").each(function() {
        this.addEventListener("activescrollanim", function() {
            jQuery(this).find("[data-nb]").each(function() {
                var e;
                e = this, new morphHTMLNumber({
                    el: e,
                    finalValue: parseInt(e.getAttribute("data-nb"), 10),
                    time: 2e3
                })
            })
        })
...
jQuery(document).ready(function(e) {
    jQuery(".block--posts").each(function() {
        jQuery(this)
    })
});
jQuery(document).ready(function(e) {
    jQuery(".block--steps").each(function() {
        jQuery(this)
    })
});
jQuery(document).ready(function(e) {
    jQuery(".team-items-item .img").each(function() {
        var e = jQuery(this);
        e.on("mousemove", function(t) {
            var o = e.get(0),
                n = o.getBoundingClientRect(),
                s = t.clientX - n.x - n.width,
                u = t.clientY - n.y - n.height;
            o.style.setProperty("--mouse-x", s + "px"), o.style.setProperty("--mouse-y", u + "px")
        }), e.on("mouseleave", function(t) {
            e.get(0).style.setProperty("--mouse-x", "0px"), e.get(0).style.setProperty("--mouse-y", "0px")
        })
    })
});
jQuery(document).ready(function(e) {
    jQuery(".block--testimonials").each(function() {
        jQuery(this)
    })
});
jQuery(document).ready(function(e) {
    jQuery(".field-video .wpuacf-video").each(function() {
        var e = jQuery(this);
        e.on("mousemove", function(t) {
            var o = e.get(0),
                n = o.getBoundingClientRect(),
                u = t.clientX - n.x,
                s = t.clientY - n.y;
            o.style.setProperty("--mouse-x", u + "px"), o.style.setProperty("--mouse-y", s + "px")
        }), e.on("mouseleave", function(t) {
            e.get(0).style.setProperty("--mouse-x", "0px"), e.get(0).style.setProperty("--mouse-y", "0px")
        })
    })
...
jQuery(document).ready(function(e) {
    jQuery(".block--word").each(function() {
        jQuery(this)
    })
});
(function() {
